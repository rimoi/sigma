 ...
 */
final class Version20230626050207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE booking (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, mission_id INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', archived TINYINT(1) NOT NULL, confirm_started DATETIME DEFAULT NULL, confirm_ended DATETIME DEFAULT NULL, validate TINYINT(1) DEFAULT 0 NOT NULL, INDEX IDX_E00CEDDEA76ED395 (user_id), INDEX IDX_E00CEDDEBE6CAE90 (mission_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE mission (id INT AUTO_INCREMENT NOT NULL, file_id INT DEFAULT NULL, user_id INT DEFAULT NULL, service_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', started DATETIME NOT NULL, ended DATETIME DEFAULT NULL, booked TINYINT(1) DEFAULT 0 NOT NULL, archived TINYINT(1) NOT NULL, published TINYINT(1) DEFAULT 0 NOT NULL, slug VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, zip_code INT NOT NULL, city VARCHAR(255) NOT NULL, emergency TINYINT(1) DEFAULT 0 NOT NULL, phone VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_9067F23C93CB796C (file_id), INDEX IDX_9067F23CA76ED395 (user_id), INDEX IDX_9067F23CED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, address VARCHAR(255) DEFAULT NULL, zip_code INT DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, contact_name VARCHAR(255) DEFAULT NULL, public VARCHAR(255) DEFAULT NULL, unity_name VARCHAR(255) DEFAULT NULL, INDEX IDX_E19D9AD2A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sms (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', send TINYINT(1) NOT NULL, phone VARCHAR(255) DEFAULT NULL, sender VARCHAR(255) DEFAULT NULL, INDEX IDX_B0A93A77A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, iban_id INT DEFAULT NULL, cni_id INT DEFAULT NULL, permis_conduite_id INT DEFAULT NULL, criminal_record_id INT DEFAULT NULL, autoentreprise_certificate_id INT DEFAULT NULL, file_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, adress VARCHAR(255) DEFAULT NULL, zip_code INT DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, siret VARCHAR(255) DEFAULT NULL, tva VARCHAR(255) DEFAULT NULL, is_verified TINYINT(1) NOT NULL, enabled TINYINT(1) NOT NULL, archived TINYINT(1) DEFAULT 0 NOT NULL, slug VARCHAR(255) DEFAULT NULL, gender VARCHAR(255) DEFAULT NULL, social_reason VARCHAR(255) DEFAULT NULL, public VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D64920D5BAF6 (iban_id), UNIQUE INDEX UNIQ_8D93D649C68EB1D0 (cni_id), UNIQUE INDEX UNIQ_8D93D649854F43FD (permis_conduite_id), UNIQUE INDEX UNIQ_8D93D6495C980E05 (criminal_record_id), UNIQUE INDEX UNIQ_8D93D64990D9BC9E (autoentreprise_certificate_id), UNIQUE INDEX UNIQ_8D93D64993CB796C (file_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
